...
Toolsmith is currently MIT-licensed first-party code, but it is inspired by or may later incorporate compatible pieces from these projects. Keep this file updated before copying code or substantial implementation details.
...
- If code is incorporated: include the MIT copyright and permission notice in copies/substantial portions.
