  ...
  "anchored_search",
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        contextLines: { type: "integer", minimum: 0, maximum: 50, description: "Context lines before and after each match. Default 1." },
  ...
  "find_and_anchor",
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        caseSensitive: { type: "boolean", description: "Case-sensitive matching. Default false." },
        contextLines: { type: "integer", minimum: 0, maximum: 50, description: "Context lines before and after each match. Default 2." },
